...
@net_G_models.add_to_registry("cnn_32_dcgan")
class Generator32_dcgan(Generator_dcgan):
    def __init__(self, z_dim):
        super().__init__(z_dim, M=2)


@net_G_models.add_to_registry("cnn_48_dcgan")
...
@net_G_models.add_to_registry("cnn_32_sngan")
...
@net_G_models.add_to_registry("res_32_sngan")
...
@net_G_models.add_to_registry("cnn_32_wgan")
class Generator32_wgan(Generator):
    def __init__(self, z_dim):
        super().__init__(z_dim, M=4)


@net_G_models.add_to_registry("res_32_wgan")
class ResGenerator32(nn.Module):
    def __init__(self, z_dim):
        super().__init__()
        self.z_dim = z_dim
